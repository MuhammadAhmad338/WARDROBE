  ...
  return (
    <>
      ...
      <header className="relative flex justify-between items-center px-6 py-6 bg-white shadow-md">
        ...
        {/* Center: Logo */}
        <div className="absolute left-1/2 transform -translate-x-1/2 text-xl sm:text-2xl lg:text-3xl text-black">
          <Link to="/">W A R D R O B E</Link>
        </div>
        <div
          className="custom-lg:hidden text-black cursor-pointer"
        ...
        {isDrawerOpen && (
          <div className="fixed inset-0 bg-gray-800 bg-opacity-75 z-50 lg:hidden">
            <div className="absolute top-0 left-0 h-full w-4/5 sm:w-82 bg-white shadow-lg rounded-lg p-4">
              <button className="text-gray-800 mb-4" onClick={toggleDrawer}>
                X
              </button>
          ...
          <div className="absolute top-0 right-0 h-full w-4/5 sm:w-80 lg:w-1/3 xl:w-1/4 bg-white shadow-lg rounded-lg">
            <div className="p-4 flex flex-col h-full">
              <div className="flex justify-between items-center mb-4">
                ...
                <button className="text-gray-800" onClick={toggleCart}>
                  Close
                </button>
              </div>
              ...
              <Link to={"/cart"}>
                <button
                  onClick={toggleCart}
                  className="mt-6 w-full bg-black border border-black text-white py-2 px-4 hover:bg-white hover:text-black hover:border-black"
                >
                  View Cart
                </button>
              </Link>
      ...
      {isSearchOpen && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-75 z-50">
          <div className="absolute top-0 right-0 h-full w-4/5 sm:w-80 lg:w-60 bg-white shadow-lg">
            <div className="p-4">
              Search Content
              <button className="text-gray-800" onClick={toggleSearch}>
                Close
              </button>
            </div>
          </div>
