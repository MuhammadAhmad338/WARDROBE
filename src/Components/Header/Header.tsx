      ...
      <>
        ...
        <header className="relative flex justify-between items-center px-6 py-6 bg-white shadow-md">
          ...
          <div className="flex space-x-4 custom-lg:flex hidden">
            ...
            <Link to="/allProducts" className="text-black text-sm hover:text-gray-500">New Arrivals</Link>
            <Link to="/allProducts" className="text-black text-sm hover:text-gray-500">All Products</Link>
          </div>
              ...
              <div className="fixed inset-0 bg-gray-800 bg-opacity-75 z-50 lg:hidden">
                <div className="absolute top-0 left-0 h-full w-4/5 sm:w-82 bg-white shadow-lg rounded-lg p-4">
                  ...
                  <div className="flex flex-col space-y-4">
                    ...
                    <Link to="/contact" className="text-black hover:text-gray-500" onClick={toggleDrawer}>Contact
                      Us</Link>
                    <Link to="/allProducts" className="text-black hover:text-gray-500" onClick={toggleDrawer}>New
                      Arrivals</Link>
                    <Link to="/allProducts" className="text-black hover:text-gray-500" onClick={toggleDrawer}>All
                      Products</Link>
                  </div>
                </div>
              </div>
